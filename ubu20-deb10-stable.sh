...
IZIN=$(curl https://raw.githubusercontent.com/rasta-team/V5/main/Regist | grep $MYIP | awk '{print $4}')
if [ $MYIP = $IZIN ]; then
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/rasta-team/V5/main/"
...
echo -e "\e[32mloading...\e[0m" 
clear
izinsc="https://raw.githubusercontent.com/rasta-team/V5/main/Regist"
# USERNAME
rm -f /usr/bin/user
...
wget -q https://raw.githubusercontent.com/rasta-team/V5/main/config/fv-tunnel && chmod +x fv-tunnel && ./fv-tunnel
